...
Verbatim copy of src/bot/search.py as of the start of the optimization work
(branch modernize-bot, parent ba018dc). Exists solely so tools/gauntlet.py can
play the optimized search against the original and measure Elo.
"""
